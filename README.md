...
- **[aibirthday](https://github.com/kireikov/aibirthday)** — a five-agent pipeline that drafts, approves, and sends personalised birthday greetings via Gmail + Claude Opus with adaptive thinking. Consent gate is a tag in the contact's notes, not a daily confirmation — a small detail that makes the thing actually usable.
